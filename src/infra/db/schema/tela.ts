 ...
 * (`modo` estacao|geral|setor + `estacao_id`/`setor_id`); a TV relê ao receber o ping do realtime.
 * Read-only: a tela só EXIBE o painel. Longo-viva (fica na parede); o controle é a REVOGAÇÃO manual
 * (`revogado_em`).
 */
