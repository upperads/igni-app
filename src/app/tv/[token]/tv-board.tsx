    ...
    <div className="flex min-h-dvh flex-col bg-grafite-900">
      ...
      <main className="min-h-0 flex-1 px-6 py-6">
        {etapas.length === 0 ? (
          ...
          // KANBAN: uma COLUNA por etapa (lê da esquerda pra direita, como o fluxo da produção),
          // cards empilhados na coluna. Scroll horizontal se não couber na largura da TV.
