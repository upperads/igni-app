...
- **Execução — ondas**:
  ...
  - Wave 3d (UI) — **em andamento.**
    ...
    - *Faltam (Wave 3d):* recuperação de conta; read-only por papel na UI; **US-17 "Primeiros passos"**. — card na Home + rota `/primeiros-passos`, copy anti-IA, visual impecável; conteúdo em `docs/conteudo/primeiros-passos.md`), Next 16 — pendente.
