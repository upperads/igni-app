...
- **Execução — ondas**:
  ...
  - Wave 3d (UI) — **em andamento.**
    ...
    - *Faltam (Wave 3d):* recuperação de conta (reset por e-mail); read-only por papel na UI (`pode()`). — card na Home + rota `/primeiros-passos`, copy anti-IA, visual impecável; conteúdo em `docs/conteudo/primeiros-passos.md`), Next 16 — pendente.
