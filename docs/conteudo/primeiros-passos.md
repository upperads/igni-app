<!--
  Conteúdo-fonte da rota /primeiros-passos e do card de onboarding na Home (US-17).
  Voz obrigatória: prosa calma e didática, frases de comprimento variado, quase sem travessão.
  Não picotar em frases curtas soltas. Ao editar, mantenha esse tom. Render na Wave 3d.
-->

# Primeiros passos no Igni

## Antes de configurar qualquer coisa
...
## 1. Crie a sua oficina e escolha o seu ramo
...
## 2. Confira as estações que já vieram prontas
...
## 3. Convide a sua equipe e dê a cada um o papel certo
...
## 4. Abra a sua primeira ordem de serviço
...
Conforme o trabalho avança pelas estações, a ordem caminha junto e vai respondendo sozinha às quatro perguntas. Você vai perceber que perguntar "onde está aquele motor do cliente tal?" deixa de ser necessário, porque a resposta já está na tela.

## 5. Compartilhe o acompanhamento com o cliente
...
## 6. Coloque o painel na TV do setor
