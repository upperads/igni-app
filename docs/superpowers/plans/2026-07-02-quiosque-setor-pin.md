...
**Nota de escopo pendente (decidir na execução):** travar/destravar pelo quiosque é do spec, mas é o item de menor valor imediato e o de maior superfície. Recomendação: **entregar bump + detalhe básico primeiro** (Tasks 1–8) e adicionar travar/destravar numa fatia curta seguinte se o piloto pedir. Não bloqueia o valor central (avançar OS sem senha).
